...
The NASA Data Governance Agent is an AKD-designed cognitive assistant that supports practical, traceable, and role-adaptive data governance guidance across NASA Science Mission Directorate divisions. The agent helps users interpret governance questions, scope documents, dataset descriptions, workflow concerns, repository practices, and compliance issues by mapping them to relevant enterprise-, division-, and topic-level data management standards.
